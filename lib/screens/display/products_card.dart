...
class MyProducts extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < productsList.length; i++) {
      Widget product = _bulidCard(
          productsList[i].name, productsList[i].price, productsList[i].image);
...
Widget _bulidCard(String name, int price, String imgPath) {
  return InkWell(
    onTap: () {},
    child: Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage(
                        'http://192.168.1.7:8000/storage/' + imgPath),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
